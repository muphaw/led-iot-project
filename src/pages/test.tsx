...
//     const actionParam = isOn ? (alarmLedAction ? "on" : "off") : "on";
...
//     const actionParam = isOn ? (timerLedAction ? "on" : "off") : "on";
...
//           <>
//             {musicEnabled ? (
//               <div className="w-full h-[180px] rounded-3xl bg-[#0b1220] border border-white/5 flex items-center justify-center overflow-hidden">
//                 <div className="flex items-center justify-center gap-[4px] h-24">
//                   {audioLevels.map((level, i) => {
//                     const height = Math.max(Math.pow(level / 255, 1.7) * 70, 8);
...
//                       >
//                         <div
//                           className="w-[3px] rounded-full bg-gradient-to-t from-cyan-500 via-cyan-300 to-white transition-all duration-100 ease-out"
//                           style={{
//                             height: `${height}px`,
...
//                 <div
//                   className={`flex justify-center ${!connected || motionEnabled ? "pointer-events-none opacity-50" : ""}`}
//                 >
//                   <button
//                     onClick={toggleLED}
...
//                 <div
//                   className={`bg-white/5 border border-white/5 py-2 px-4 rounded-2xl ${(!connected || (!isOn && !motionEnabled)) && "opacity-40 pointer-events-none"}`}
//                 >
...
//         <div
//           className={`grid grid-cols-1 sm:grid-cols-2 gap-2 ${!connected ? "pointer-events-none opacity-50" : ""}`}
//         >
//           <SensorToggleCard
//             icon={Activity}
...
//                 Turn on the LED or enable a sensor context to configure
//                 scheduled Timers and Alarms.
//               </p>
//             )
//           )}
